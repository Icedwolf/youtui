...
#![allow(deprecated)]
use crate::utils::{maybe_new_standard_api, new_standard_api};
...
#[tokio::test]
async fn test_new() {
    if maybe_new_standard_api().await.is_some() {
...
generate_stream_test!(
    ...
    GetPlaylistTracksQuery::new(PlaylistID::from_raw("PL0jp-uZ7a4g9FQWW5R_u0pz4yzV4RiOXu"))
);
generate_stream_test!(
...
generate_query_test!(
    ...
    GetPlaylistDetailsQuery::new(PlaylistID::from_raw("PL0jp-uZ7a4g9FQWW5R_u0pz4yzV4RiOXu"))
);
generate_query_test!(
    test_get_user,
